"""A collection-led Daily Flyer companion: edition-aware record stories."""
...
THEME_CONFIG = {
    ...
    "header_subtitle": "Put a few records on the table. Find the people who turn up twice.",
...
<div class="vinyl-app" id="vinyl-app">
  <div class="vinyl-intro">
    <div><span class="vinyl-overline">YOUR RECORDS, CONNECTED</span>
      <h2>Who else is on that record?</h2>
      <p>Add a specific release, then turn credited guests and musicians into stories and a little pub-table quiz.</p>
  ...
  <div id="vinyl-status" class="vinyl-status" role="status" aria-live="polite">Start with two albums to see a crossover.</div>
