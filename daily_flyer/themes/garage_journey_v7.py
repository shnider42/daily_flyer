...
from daily_flyer.themes import garage_journey_v6 as base

THEME_NAME = "garage_journey_v7"
...
def _garage_body() -> str:
    ...
    start_marker = '<script id="gj-data" type="application/json">'
    ...
    if start != -1:
        ...
        if end != -1:
            ...
            body = body[:content_start] + payload + body[end:]
    return body
